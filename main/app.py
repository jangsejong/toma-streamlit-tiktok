...
#     followers = st.sidebar.slider('followers', 0, 625700, 0)
#     hearts = st.sidebar.slider('hearts', 22, 31000000, 22)
...
#     fig_3 = px.scatter(data, x="hearts", y="followers", animation_frame="videoMeta.duration", animation_group="hashtag.name",size='videoMeta.duration', color="authorMeta.verified", hover_name="shareCount") 
#     # st.plotly_chart(fig_3, use_container_width=True)
#     left_col.plotly_chart(fig_3, use_container_width=True)

#     fig_4 = px.scatter(data, x="hearts", y="shareCount", animation_frame="videoMeta.duration", animation_group="hashtag.name",size='videoMeta.duration', color="authorMeta.verified")
